...
const PATTERN_WIDTH : u32 = 48u;
const PATTERN_HEIGHT : u32 = 31u;
const PATTERN_RUN_COUNT : u32 = 84u;
...
// Run-length encoded live cell spans from tmp/gol-components/p120.lif (y, x, len).
const PATTERN_RUNS : array<Run, 84> = array<Run, 84>(
    Run(0u, 45u, 2u),
    Run(1u, 46u, 2u),
    Run(2u, 45u, 1u),
    Run(4u, 35u, 2u),
