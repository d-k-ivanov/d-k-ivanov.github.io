...
const float sqr2 = 1.4142135623730950488016887242096980785696f, // square root of 2
sqr3 = 1.7320508075688772935274463415058723669428f, // square root of 3.0
...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    center = 0.5f * iResolution.xy;        // viewport center in DC
